@if(!empty($editRoute))
    <a href="{{$editRoute}}">
        <button type="button" class="btn btn-icon-toggle btn-sm" data-toggle="tooltip" data-placement="top" data-original-title="Edit">
...
@if(!empty($deleteRoute))
    <a href="#"><button type="button" data-route="{{$deleteRoute}}" class="btn btn-icon-toggle btn-delete p-1" data-toggle="tooltip" id="sa-warning" data-placement="top" data-original-title="Delete">
